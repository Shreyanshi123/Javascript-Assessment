...
function listNFTs() {
    for (let a = 0; a < NFTs.length; a++) {
        console.log('NFT ID:', a + 1);
        console.log('NFT Pokemon:', NFTs[a].Pokemon);
        console.log('NFT Pokemon_type:', NFTs[a].Pokemon_type);
        console.log('NFT Power_Level:', NFTs[a].Power_level);
        console.log('NFT Level:', NFTs[a].Level);
    }
}

// print the total number of NFTs we have minted to the console
function getTotalSupply() {
    console.log("Total Amount of Cards: " + NFTs.length);
}
